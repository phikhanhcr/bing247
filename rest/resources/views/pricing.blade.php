                ...
                <div class="row justify-content-center">
                    <div class="col-xl-8 col-lg-8 col-md-10 col-sm-11 col-xs-11">
                        <div class="breadcrumb-section__content hero-content text-center">
                            ...
                            <h3 class="text-dark mb-20">Organize your work with Workoutnow Premium</h2>
                            {{-- <p class="text-light">Quickly record your archievements and thoughts with messenger-styled notes.</p>
                            <p class="text-light">More functions. More peace of mind. Workoutnow Premium is a bit of your second brain (and more reliable)..</p>
                            <p class="text-light">Celebrate your progress. Trust the premium features of Workoutnow to help you manage your work, no matter how complex..</p>
                            <p class="text-light">More than 500,000 people rely on Workoutnow Premium to structure their work and personal life.</p> --}}
