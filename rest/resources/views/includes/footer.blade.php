            ...
            <div class="col-lg-3 col-xl-3 col-xxl-3 col-sm-6 col-xs-9 col-10 order-sm-1 order-lg-1">
                <div class="footer-content text-center text-sm-start">
                    <a href="{{ route("getIndex") }}" class="footer-content--logo d-block mb-0">
                        <img src="/img/workout/Workoutnow-b-01.png" style="max-width: 180px;" alt="logo">
                    </a>
                    <p class="footer-content--text text-dark">Workoutnow with powerful marketing tools designed to
                        help you create more engaging content, get more followers, and make your business shine online.
                    </p>
                </div>
            </div>
