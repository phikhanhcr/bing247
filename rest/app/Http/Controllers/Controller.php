...
class Controller extends BaseController
{
    ...
    public function getSeoData($data = []) {
        $seo = [
            ...
            'description' => ' A better way to track your workout | Workoutnow.co',
            'keywords' => '',
        ...
        switch ($GLOBALS['routeName']) {
            case 'getIndex':
                $seo['title'] = 'Workoutnow.co | A better way to track your workout ';
                break;
            default:
                $seo['title'] = 'A better way to track your workout ';
                break;
        }
