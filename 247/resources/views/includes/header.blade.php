        ...
        <nav class="navbar site-navbar">
            ...
            <div class="site-header__brand">
                <a href="{{ route('getIndex') }}">
                    ...
                    <img src="/img/247/247workout-w-01.png" style="max-width: 160px" alt="" class="logo-white">
                    <!-- Dark version logo (logo must be White)-->
                    <img src="/img/247/247workout-b-01.png" style="max-width: 160px" alt="" class="logo-black">
                </a>
            </div>
