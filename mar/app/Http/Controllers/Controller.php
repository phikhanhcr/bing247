...
class Controller extends BaseController
{
    ...
    public function getSeoData($data = []) {
        $seo = [
            ...
            'description' => ' Deliver exceptional marketing experiences with Marketingsolu',
            'keywords' => '',
        ...
        switch ($GLOBALS['routeName']) {
            case 'getIndex':
                $seo['title'] = 'marketingsolu.com | Deliver exceptional marketing experiences with Marketingsolu';
                break;
            default:
                $seo['title'] = ' Deliver exceptional marketing experiences with Marketingsolu';
                break;
        }
