                ...
                <div class="row justify-content-center">
                    <div class="col-xl-8 col-lg-8 col-md-10 col-sm-11 col-xs-11">
                        <div class="breadcrumb-section__content hero-content text-center">
                            ...
                            <h3 class="text-light mb-20">Organize your work with Marketingsolu Premium</h2>
                            {{-- <p class="text-light">Quickly record your archievements and thoughts with messenger-styled notes.</p>
                            <p class="text-light">More functions. More peace of mind. Marketingsolu Premium is a bit of your second brain (and more reliable)..</p>
                            <p class="text-light">Celebrate your progress. Trust the premium features of Marketingsolu to help you manage your work, no matter how complex..</p>
                            <p class="text-light">More than 500,000 people rely on Marketingsolu Premium to structure their work and personal life.</p> --}}
                            ...
                            <div class="row justify-content-center">
                                <div style="width: 600px; margin: 30px auto 0 auto">
                                    ...
                                    <div class="text-light">
                                        ...
                                        <a href="/privacy-policy" class="text-dark" target="_blank">Privacy Policy</a>. You also agree
